...
def parse_uc(ucfile, group_sg_file, count_file=None, write_count=False):
...
parser = argparse.ArgumentParser(description="Parse .uc file to find the groups and statistics of the groups",
                                 ...
                                 # print default values for options in help
                                 # message
...
parser.add_argument("--count", action='store_true',
                    help="save the count file?", dest="write_count")
parser.add_argument("-c", "--countfile", help="file name for group counts",
                    dest='countfile', default=sys.stdout, type=argparse.FileType('w'))
# output file name
parser.add_argument(
    "-g", "--group", help="group file with seq -- group format", dest='groupfile')
